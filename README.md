...
- **Immediate Output**: Provides descriptive statistics of the dataset, offering initial insights into data quality and features. 
  ...
  ![Train Split Statistics](assets/trainsplit.png)
  *Screenshot: Descriptive statistics generated for the Training dataset by the StatisticsGen component.*

  ![Eval Split Statistics](assets/eval%20split.png)
  *Screenshot: Descriptive statistics generated for the Evaluation dataset by the StatisticsGen component.*

  ![Test Split Statistics](assets/test%20split.png)
  *Screenshot: Descriptive statistics generated for the Test dataset by the StatisticsGen component.*
#### 3. SchemaGen
...
- **Immediate Output**: Produces a schema of the dataset, essential for data validation and understanding.
  ![SchemaGen Output](assets/SchemaGen.png)

  *Screenshot: Schema generated by the SchemaGen component, illustrating the structure and types of data fields.*  
#### 4. ExampleValidator
...
- **Immediate Output**: Outputs transformed datasets with newly engineered features, optimized for model performance.
   ![Transform Output](assets/Trasnform.png)
  *Screenshot: Output of the Transform component showing the feature engineering process.*
#### 6. Tuner
...
- **Immediate Output**: Delivers the best set of hyperparameters discovered for the model.
   ![Tuner Output](assets/Tuner.png)
  *Screenshot: Output of the Tuner component displaying the hyperparameter tuning process.*
#### 7. Trainer
...
- **Immediate Output**: Yields a trained model, ready for evaluation and potential deployment.
   ![Trainer Output](assets/Trainer.png)
  *Screenshot: Output of the Trainer component illustrating the model training phase.*
#### 8. Evaluator
...
- **Immediate Output**: Provides key evaluation metrics indicating the model's performance.
  ...
  *Screenshot: Output of the Evaluator component showing the model evaluation metrics.*
...
- **Immediate Output**: Ensures the model is deployed to a specified server or cloud environment, confirming successful deployment.
   ![Pusher Output](assets/Pusher.png)
  *Screenshot: Output of the Pusher component indicating the model deployment process.*
